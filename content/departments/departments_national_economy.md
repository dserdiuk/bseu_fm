...
Кафедра является выпускающей по специальности 1-26 01 01 «Государственное управление». Преподаватели кафедры проводят занятия по всем формам обучения на десяти факультетах университета.

[Перечень закрепленных за кафедрой дисциплин](/fm/files/gos-educ.doc)
...
На кафедре функционирует студенческая научно-исследовательская лаборатория.
